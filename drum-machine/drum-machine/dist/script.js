...
class App extends React.Component {
  ...
  handleVolumeChange = (e) => {
    this.setState({
      ...
      text: this.state.power ? "Volume: " + e.target.value : ""
    });
  };
  ...
  handleBankToggle = (e) => {
    this.setState({
      bank: this.state.bank ? 0 : 1,
      text: !this.state.power
        ? ""
        : this.state.bank
        ? "Heater Kit"
        : "Smooth Piano Kit"
    ...
    return (
      <div id="drum-machine" className="container">
        ...
        <div className="board">
          ...
          <div className="pane">
            <div
              className={this.state.power ? "power" : "power red"}
            ...
            <div className="bankContainer">
              ...
              <div className="bank" onClick={this.handleBankToggle}>
                <div
                  className={this.state.bank ? "toggle right" : "toggle left"}
                ></div>
              </div>
            </div>
          </div>
    ...
    <div className="keyboard">
      {props.keys.map((k, index) => (
        <Key
          ...
          name={k}
          volume={props.volume}
          url={keyMap[k].urls[props.bank]}
          onClick={(e) => props.onClick(k, e)}
          onKeyPress={(e) => props.onKeyPress(k, e)}
        />
      ))}
    </div>
  );
