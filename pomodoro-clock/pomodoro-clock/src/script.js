$(() => {
  ...
  function audioSelect(e) {
    ...
    switch (e.target.id) {
      case "Yung Bae - Welcome to the Disco":
        $audio.attr(
          "src",
          "https://raw.githubusercontent.com/karlwhite247/testable-projects-fcc/master/songs/1%20Yung%20Bae%20-%20Welcome%20to%20the%20Disco.mp3"
        );
        break;

      case "Ikimono-gakari - Aoi Aoi Ano Sora":
        $audio.attr(
          "src",
          "https://raw.githubusercontent.com/karlwhite247/testable-projects-fcc/master/songs/2%20Ikimono-gakari%20-%20Aoi%20Aoi%20Ano%20Sora.mp3"
        );
        break;
      ...
      case "Flow - Hero":
        $audio.attr(
          "src",
          "https://raw.githubusercontent.com/karlwhite247/testable-projects-fcc/master/songs/3%20Flow%20-%20Hero.mp3"
        );
        break;

      case "Shirō Sagisu - Final Getsuga Tenshou":
        $audio.attr(
          "src",
          "https://raw.githubusercontent.com/karlwhite247/testable-projects-fcc/master/songs/4%20Bleach%20-%20Final%20Getsuga%20Tenshou.mp3"
        );
        break;

      case "Norihito Sumitomo - Kakarot Vs Broly":
        $audio.attr(
          "src",
          "https://raw.githubusercontent.com/karlwhite247/testable-projects-fcc/master/songs/5%20-%20DBZ%20Broly%20VS%20Kakarot.mp3"
        );
        break;
    }
  }
